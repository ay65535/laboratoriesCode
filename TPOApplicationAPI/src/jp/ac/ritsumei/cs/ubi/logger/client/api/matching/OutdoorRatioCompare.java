...
public class OutdoorRatioCompare extends CompareOperation{
	protected static final String LOG_TAG = "OutdoorRatioCompare";
	 ...
	 */
	public OutdoorRatioCompare( int sensorName, int valueName, int attributeName, int calculater, double constant ){
	 ...
	 * @param constant (double)
	 */
	public OutdoorRatioCompare(int operationType, int dataType, int sensorName,
	 ...
	 * @param in
	 */
	public OutdoorRatioCompare( Parcel in ) {
		super();
	...
	public boolean evaluate( SensorData latest ){
    	double sensorValue = getOutdoorRatio( latest );
//    	Log.v( LOG_TAG, this.toString() + " | " + getKey() + " = " + sensorValue);
	...
	/**
	 * return double sensor value corresponding to "sensorName.attribute.columQualifier"
	 * @param latest All sensor values
	 * @return sensor value
	 */
	public double getOutdoorRatio( SensorData latest ){
		String key = getKey()+"."+MatchingConstants.PARAM_STRING[MatchingConstants.DATABASE];
	...
	/**
	 * return "sensorName.attribute.columQualifier"
	 */
	@Override
	public String getKey() {
		return MatchingConstants.PARAM_STRING[sensorName] + "." + 
		MatchingConstants.PARAM_STRING[valueName] + "." + MatchingConstants.PARAM_STRING[attributeName];
	}
