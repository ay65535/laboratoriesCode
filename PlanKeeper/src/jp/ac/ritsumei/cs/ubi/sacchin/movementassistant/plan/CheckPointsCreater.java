...
public class CheckPointsCreater{
	...
	public static ArrayList<double[]> createCheckpoints(ArrayList<MyGeoPoint> path) {
		if(path == null){
			return null;
		}
	...
	private static ArrayList<Candidate> spliteToCandidate(ArrayList<MyGeoPoint> path, 
