...
public class GeoPointUtils {
	...
	private GeoPoint mostHighGeoPoint;
	private GeoPoint mostLowGeoPoint;
	 ...
	 * @param doDraw
	 */
	public GeoPointUtils( GeoPoint centerPoint, int range, boolean doDraw, String color ){
		int temp = ( range/25 )*100;
				
		mostHighGeoPoint = new GeoPoint( centerPoint.getLatitudeE6()+temp, centerPoint.getLongitudeE6()+temp );
		mostLowGeoPoint = new GeoPoint( centerPoint.getLatitudeE6()-temp, centerPoint.getLongitudeE6()-temp );
	 ...
	 * @param doDraw
	 */
	public GeoPointUtils( GeoPoint mostHigh, GeoPoint mostLow, boolean doDraw, String color ){
		mostHighGeoPoint = mostHigh;
		mostLowGeoPoint = mostLow;
	 ...
	 * @param color
	 */
	public GeoPointUtils(MyGeoPoint point, boolean doDraw, String color){
		mostHighGeoPoint = point.getMostHighGeoPoint();
		mostLowGeoPoint = point.getMostLowGeoPoint();
...
//				System.out.println(i + " : " + getTime(t));
		...
		Log.v("calcArivalAverage", "Average : " + sum / divide + "sec");
		return sum / divide;
	}
...
//				System.out.println(i + " : " + diff);
		...
		Log.v("calcArivalAverage", "StandardDeviation : " + 
				Math.sqrt(sum / divide) + "sec, Dispersion = " + (sum / divide));
